...
- [~] **F5-2 — Usabilidade e robustez (RNF01, RNF02)** — revisão de estados vazios/erro, responsividade, formatação de moeda/data pt-BR, acessibilidade básica.
  ...
  - [ ] Revisão de responsividade em telas estreitas.
  - [ ] Revisão de acessibilidade além do que já foi feito por tela (foco visível, ordem de tabulação, contraste).
  - [ ] Estados vazios e de erro revistos de ponta a ponta com a API real.
